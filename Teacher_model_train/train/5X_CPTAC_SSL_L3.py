...
def train():
    ...
    trainset = EmbededFeatsDataset_ProMIL(args.data,split_path=args.split_path,
                                          sheet_name=args.train_sheet,batch_size=17,
                                          stage=False)
...
def main():
    args.dataset_name="CPTAC-ssl-l3"
    ...
    for i in range(0,20):
        ...
        args.split_path = "D:\\project\\laten_mamba_main\\data\\CPTAC\\file_labels_GPTtxt_seed{}.xlsx".format(csv_seed)
