...
if __name__ == '__main__':
    ...
    dataset_path="E:"
    path_base = os.path.join(dataset_path, args.dataset)
    if len(levels) == 2:
        out_base = os.path.join(dataset_path, args.dataset, 'pyramid')
    else:
        out_base = os.path.join(dataset_path, args.dataset, 'single')
